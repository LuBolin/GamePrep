# GamePrep 学习指南（给 Bolin 的 UE 面试备考用）

这份指南不是“理想状态下每天学 6 小时”的那种计划，而是按你现在的真实情况来写的：**在职 FE 工程师，业余时间有限，目标是转游戏开发，重点是把 Unreal Engine 面试准备到“能打”的程度。**

一句话先说结论：

> 你现在这套 GamePrep 已经不是“资料收集阶段”了，而是一个可以直接拿来做系统化面试训练的知识库。接下来最重要的，不是继续囤更多内容，而是按优先级反复做“读 → 复述 → 实操/推演 → 自测 → 修补薄弱点”的循环。
...
- [[cpp_interview_question_bank]]
  - 偏 C++ 基础与 Unreal 结合。
  - 对你这种 FE 转游戏的人，这块非常重要，因为很多候选人在这里掉分。
...
你现在最容易踩的坑，是一上来就被 GAS、Mass、World Partition、NetworkPrediction 这类“听起来很高级”的主题吸走。
...
这对在职学习特别重要，不然你会一直“输入很多，输出很少”。

---

## 3. flashcards 怎么用最值钱

你现在 flashcards 已经很多，正确用法不是“从头刷到尾”，而是分层用。
...
## 6. 每周学习节奏建议：按你是在职 FE 的现实来

你现在不是全职备考，所以别用那种一周 30 小时的计划压自己。关键是**持续、可复用、能形成输出**。
...
## 9. 给你的实际执行建议：如果从今天开始，怎么用这套库

如果你现在就开始，我建议不要想太多，直接按下面这个启动。
...
对想从 FE 转游戏开发的人来说，最有说服力的状态不是“我看过很多 UE 资料”，而是：
